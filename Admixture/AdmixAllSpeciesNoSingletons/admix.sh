...
#SBATCH --chdir=/home/a619f280/work/phil.stachyris/admixture/admixnooutgroupnosingletons    # Set working d$
#SBATCH --mem-per-cpu=1gb            # memory requested
#SBATCH --time=360

#use plink to convert vcf directly to bed format:
/home/d669d153/work/plink --vcf thinned.nooutgroup.mac.lowerqualityvcf --double-id --allow-extra-chr --make-bed --out binary_fileset
