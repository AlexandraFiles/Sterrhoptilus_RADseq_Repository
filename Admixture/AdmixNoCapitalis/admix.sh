...
#SBATCH --chdir=/home/a619f280/work/phil.stachyris/admix_ordered_correct/nocap   # Set working d$
#SBATCH --mem-per-cpu=1gb            # memory requested
#SBATCH --time=360

#use plink to convert vcf directly to bed format:
/home/a619f280/work/programs/plink --vcf sterrhoptilusadmix_nocapitalis.vcf.gz --double-id --allow-extra-chr --make-bed --out binary_fileset
