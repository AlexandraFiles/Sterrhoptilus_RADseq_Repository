...
#SBATCH --chdir=/home/a619f280/work/phil.stachyris/admixture/admixonlydenandaff    # Set working d$
#SBATCH --mem-per-cpu=1gb            # memory requested
#SBATCH --time=360

#use plink to convert vcf directly to bed format:
/home/d669d153/work/plink --vcf sterrhoptilusadmix_onlydenandaff.vcf.gz --double-id --allow-extra-chr --make-bed --out binary_fileset
