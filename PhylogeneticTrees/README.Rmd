...
The folder [IQTree](IQTree) contains the bash script for running *IQTree* and all the subsequent results. I performed 1000 ultra-fast bootstrap replicates and had IQTree select the best AIC tree.
